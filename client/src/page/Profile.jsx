...
export default function Profile() {
  ...
  async function getdata (){
    ...
    // console.log(token);
    axios.post("http://172.20.10.2:5000/api/auth/user", {token:token})
    .then(res=> { 
          ...
          Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: async () => {
                  const token = await AsyncStorage.getItem('token');
                  await axios.post("http://172.20.10.2:5000/api/auth/logout", { token });
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            const token = await AsyncStorage.getItem('token');
            axios.post("http://172.20.10.2:5000/api/auth/deleteUser", { token })
              .then(async res => {
