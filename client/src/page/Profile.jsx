...
export default function Profile() {
  ...
  async function getdata (){
    ...
    useEffect(()=>{
        ...
        const handleViewSBus = () => {
          navigation.navigate("ViewSBus");
        };
...
//       headerShown: true,
//       title: "MOVELK",
//       headerTitleStyle: { color: "white", fontSize: 20, fontWeight: "bold", paddingHorizontal: "35%" },
//       headerStyle: { backgroundColor: "#FED339", height: 100 },
//     });
//   }, [navigation]);

//   async function getdata() {
//     const token = await AsyncStorage.getItem('token');
//     axios.post("http://192.168.1.6:5000/api/auth/user", { token })
...
//           <Text style={styles.infoText}>{users.UserName}</Text>
//         </View>
//         <View style={styles.infoBox}>
//           <Icon name="bus" size={20} color="black" style={styles.icon} />
//           <Text style={styles.infoText}>{users.Busname}</Text>
//         </View>
//         <View style={styles.infoBox}>
//           <Icon name="id-card" size={20} color="black" style={styles.icon} />
//           <Text style={styles.infoText}>{users.BusNumber}</Text>
//         </View>
//         <View style={styles.infoBox}>
//           <Icon name="phone" size={20} color="black" style={styles.icon} />
//           <Text style={styles.infoText}>{users.Phone}</Text>
//         </View>
...
// const styles = {
//   infoBox: { 
//     flexDirection: 'row', alignItems: 'center',        backgroundColor: "#FED339", borderRadius: 5, padding: 10 },
//   icon: { marginRight: 10 },
//   infoText: { fontSize: 16 },
//   button: { backgroundColor: 'red', padding: 10, borderRadius: 5, marginVertical: 10 },
